...
const Project = () => (
    <Layout>
        <Container>
            <Title>
             Stockify <Badge>2023</Badge>
            </Title>
            <WorkImage
                src="/images/works/stockify2.png"
                alt="stockify"
            />
            <P>
            ...
            <List>
                <ListItem>
                    <Meta>Link</Meta>
                    <Link href="https://github.com/jck-bit/stockify">
                    https://github.com/jck-bit/stockify
                ...
                <ListItem>
                    <Meta>Stack</Meta>
                    <Link>Typescript | HTML  | CSS</Link>
                </ListItem>
            </List>
            <br/>
            <WorkImage src="/images/works/stockify1.png"/>
        </Container>
    </Layout>
)
